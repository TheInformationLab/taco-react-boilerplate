...
class MyParser extends Parser {
    parse(fetcherResult, input, context) {
        ...
        table.addRows(fetcherResult.features.map((row)=>{
            return {
                id: row.id,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2lGWx"}],"2lGWx":[function(require,module,exports) {
